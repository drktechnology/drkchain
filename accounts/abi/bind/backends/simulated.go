...
// FeeAt returns the wei fee of a certain account in the blockchain at specific blocknumber
func (b *SimulatedBackend) FeeAt(ctx context.Context, contract common.Address, blockNumber *big.Int) (*big.Int, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
	...
	statedb, _ := b.blockchain.State()
	return statedb.GetFee(contract), nil
}
